        ...
        <section id="about" className={styles.aboutSectionWrapper}>
            ...
            <div className={styles.aboutInfoSection}>
                <div className={styles.aboutCompanyDescription}>
                    ...
                    Произведенные нами винты, винты самонарезающие, винты сегментные, болты, оси применяются в производстве автомобилей, электроустановочных изделий, электрощитового оборудования, мебели, пластиковых окон и дверей, холодильников, другой бытовой техники.
                ...
                <Image src={imageSrc} alt="Описание изображения" width={500}  />
            </div>
